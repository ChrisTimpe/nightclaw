...
<!-- Two default entries are provided below. To activate them for overnight use:
...
|-------|---------------|---------------------|
| `phase-auto-transition` | Worker auto-advances to next phase when stop condition met | Changing mission, deleting project, adding new project |
